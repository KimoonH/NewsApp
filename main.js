...
const getLatesNews = async () => {
    //url 주소를 가져오기
    const url = new URL(`https://master--newsapp90.netlify.app/?q=${keyword}&country=kr&pageSize=${PAGE_SIZE}`) // 개발자 필요로 하는 함수를 제공해주는데, URL()함수를 만듬. url인스턴스라고 부름. url에 필요한 함수와 변수들을 제공. 새로운 URL인스턴스를 만들어준다.
